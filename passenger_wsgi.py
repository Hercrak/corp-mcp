...
TOOLS = [
    ...
    },
    {
        ...
        'inputSchema': {
            'type': 'object',
            'properties': {
                'tipo': {'type': 'string', 'description': 'Tipo: FCT, NCR, NDB, RIV, ISL'},
    ...
    {
        'name': 'buscar_compra',
        'description': 'Busca un documento de compra por tipo y número. Ejemplo: tipo=FCT, numero=1',
        'inputSchema': {
            'type': 'object',
            'properties': {
                'tipo': {'type': 'string', 'description': 'Tipo: FCT, NCR, NDB, RIV, ISL'},
    ...
    },
    {
        ...
        'description': (
            'Resumen de compras agrupado por tipo de documento con totales y cantidades. '
    ...
    },
    {
        ...
        'description': (
            'Consulta socios comerciales: proveedores, suplidores, acreedores. '
            'Incluye nombre, RIF e información de contacto.'
        ),
        'inputSchema': {
            'type': 'object',
            'properties': {
...
def _call_tool(name, arguments):
    # Fase 2: reemplazar con queries MySQL
    msg = f'[Fase 1] Herramienta {name} recibida. Args: {json.dumps(arguments, ensure_ascii=False)}. BD pendiente.'
    return msg
