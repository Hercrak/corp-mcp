...
def _call_tool(name, arguments):
    # TODO Fase 2: reemplazar con queries MySQL reales
    placeholder = {
        ...
        'consultar_compras': f'Filtros recibidos: {json.dumps(arguments)}. Conexión a base de datos pendiente (Fase 2).',
        'buscar_compra': f'Buscando: {json.dumps(arguments)}. Conexión a base de datos pendiente (Fase 2).',
        'resumen_compras': 'Servidor MCP Python activo. Conexión a base de datos pendiente (Fase 2).',
        'consultar_socios': f'Filtros recibidos: {json.dumps(arguments)}. Conexión a base de datos pendiente (Fase 2).',
    }
